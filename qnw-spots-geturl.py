# -*- coding: utf-8 -*-
"""
Created on Thu Jun 11 09:49:43 2020
...
#                }
    ...
    for i in range(81,138):
        ...
        urls = html.xpath('//ul[@class="list_item clrfix"]/li/a/@href')
        for url in urls:
            with open('D:/Desktop/明寰科技/去哪儿爬虫/景点信息/xiamen_spots.txt','a',encoding='utf-8')as f:
                f.write(url+'\n')
                print(url)
